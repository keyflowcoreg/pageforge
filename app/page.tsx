...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Nav */}
      <nav className="z-50 bg-[#0A0A0F]/95 backdrop-blur border-b border-white/10">
      ...
      <main className="flex-1">
        ...
        <section className="relative py-24 px-6 text-center overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            >
              <div className="rounded-xl border border-indigo-500/20 bg-zinc-900/80 shadow-2xl shadow-indigo-500/10 overflow-hidden backdrop-blur-sm">
                <div className="flex items-center gap-2 border-b border-zinc-800 bg-zinc-900 px-4 py-2.5">
                  ...
                  <div className="flex-1 mx-8 bg-zinc-800 rounded-md px-3 py-1 text-xs text-zinc-500 font-mono text-center">
                    your-startup.com
                  </div>
                </div>
                <div className="p-6 bg-gradient-to-b from-indigo-950/20 to-zinc-950">
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 mb-6">
                      <div className="h-6 w-6 rounded bg-indigo-500/30" />
                      <div className="h-3 w-24 rounded bg-zinc-700" />
                      <div className="ml-auto flex gap-3">
                        <div className="h-2 w-12 rounded bg-zinc-800" />
                        <div className="h-2 w-12 rounded bg-zinc-800" />
                        <div className="h-5 w-16 rounded bg-indigo-600/50" />
                      </div>
                    </div>
                    <div className="text-center space-y-3 py-4">
                      <div className="h-4 w-3/4 rounded bg-zinc-700/60 mx-auto" />
                      <div className="h-4 w-1/2 rounded bg-indigo-500/20 mx-auto" />
                      <div className="h-2.5 w-2/3 rounded bg-zinc-800 mx-auto mt-2" />
                      <div className="h-8 w-32 rounded-lg bg-indigo-600/40 mx-auto mt-4" />
                    </div>
              ...
              <div className="mt-3 flex justify-center">
                <span className="inline-flex items-center gap-1.5 text-xs text-indigo-400/60 font-medium">
                  <span className="h-1.5 w-1.5 rounded-full bg-indigo-400 animate-pulse" />
                  Generated by AI in 3.2 seconds
                </span>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-white/10 p-6 bg-white/[0.03] hover:bg-white/[0.06] hover:shadow-lg hover:shadow-indigo-500/5 hover:border-indigo-500/20 transition-all"
                >
