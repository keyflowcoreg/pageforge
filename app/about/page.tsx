...
const ECOSYSTEM = [
  ...
  { name: 'PageForge', desc: 'AI landing page generator', href: 'https://pageforge-phi.vercel.app', active: true },
    ...
    <div className="min-h-screen bg-zinc-950">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.1 }} className="mb-16">
          <Link href="/" className="text-sm text-zinc-500 hover:text-white transition-colors mb-8 inline-block">&larr; Back to PageForge</Link>
          <h1 className="text-4xl font-bold text-white mb-4">About PageForge</h1>
        ...
        <motion.section {...fadeUp} transition={{ delay: 0.2 }} className="mb-16">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8">
            <p className="text-zinc-300 leading-relaxed mb-4">
              AI Business Factory builds developer tools powered by AI. We believe every developer and founder should be able to launch a polished landing page in minutes, not days.
            </p>
            <p className="text-zinc-300 leading-relaxed">
              PageForge uses Gemini 2.0 Flash to generate complete, production-ready landing pages from a simple text description. Describe your product, choose a style, and get clean Next.js code you can deploy instantly.
            </p>
          </div>
        </motion.section>
            ...
            {ECOSYSTEM.map((product) => (
              ...
              >
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {product.active && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-indigo-500/20 text-indigo-400">You are here</span>
                  )}
                </div>
        ...
        <motion.section {...fadeUp} transition={{ delay: 0.4 }} className="mb-16">
          ...
          <div className="flex flex-wrap gap-2">
            {['Next.js', 'TypeScript', 'React', 'Tailwind CSS', 'Framer Motion', 'Gemini 2.0 Flash', 'Vercel', 'Stripe + x402'].map((tech) => (
